...
test("validateFile / denyFiles.client / env:client / failed string validation", () => {
  expect(() =>
    validateFile({
...
test("validateFile / denyFiles.client / env:client / failed regex validation", () => {
  expect(() =>
    validateFile({
      absolutePath: fromCwd("/lib/server-only.ts"),
      denyFiles: {
...
test("validateFile / denyFiles.client / env:client / failed validation without importer", () => {
  expect(() =>
    validateFile({
      absolutePath: fromCwd("/lib/server-only.ts"),
      denyFiles: {
...
test("validateFile / denyFiles.client / env:client / passed validation", () => {
  expect(() =>
    validateFile({
...
test("validateFile / denyFiles.client / env:server / ignores denyFiles.client", () => {
  expect(() =>
    validateFile({
      absolutePath: fromCwd("/lib/server-only.ts"),
      denyFiles: {
...
test("validateFile / denyFiles.server / env:server / passed validation", () => {
  expect(() =>
    validateFile({
      absolutePath: fromCwd("/lib/some-other-file.ts"),
      denyFiles: {
...
test("validateFile / denyFiles.server / env:client / ignores denyFiles.server", () => {
  expect(() =>
    validateFile({
      absolutePath: fromCwd("/lib/client-only.ts"),
      denyFiles: {
